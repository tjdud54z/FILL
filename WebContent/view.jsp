			...
			<div class="row">
				<table class="table table-striped"
					...
					+ bbs.getEx_bbsDate().substring(14, 16) + "분"%></td>
						...
						<tr>
							<td>첨부파일</td>
							<td colspan="2" style="min-height: 200px; text-align: left;"><a href="fileDownload.jsp">사진 다운로드</a></td>
						</tr>				
			   ...
			   <a href="bbs_exchange.jsp" class="btn btn-primary">목록</a>
				...
				<a href="update.jsp?ex_bbsNo=<%=ex_bbsNo%>" class="btn btn-primary">수정</a>
				<a onclick="return confirm('정말로 삭제하시겠습니까?')" href="deleteAction.jsp?ex_bbsNo=<%= ex_bbsNo %>" class="btn btn-primary	">삭제</a>				
