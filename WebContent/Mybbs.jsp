							...
							<table class="table table-striped"
								...
								<tbody>
									...
									<%
										...
										ArrayList<MypageDTO> list = bbsDAO.getList(pageNumber);
										for (int i = 0; i < list.size(); i++) {
									%>

									<tr>
										<td><%=list.get(i).getMy_bbsNo()%></td>
										<td><a
											href="view.jsp?my_bbsNo=<%=list.get(i).getMy_bbsNo()%>"><%=list.get(i).getMy_bbsTitle()%></a></td>
										<td><%=list.get(i).getUserID()%></td>
										<td><%=list.get(i).getMy_bbsDate().substring(0, 11)%></td>
									</tr>
