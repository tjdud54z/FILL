...
function check(){
 ...
 if(document.frmSignup.userID.value==""){ //id값이 없을 경우
	 alert("아이디를 입력하세요");         //메세지 경고창을 띄운 후
	 document.frmSignup.userID.focus();     // id 텍스트박스에 커서를 위치
	 exit;
 
 }else if(document.frmSignup.userNickname.value==""){
	 alert("닉네임을 입력하세요");
...
<div id="skipnav"><a href="#maincontent">Skip to main content</a></div>
   ...
   <section style="background-color: #E7E7E7;">
    ...
    <div class="col-sm-6">
    <br><h2>회원가입</h2><br>
    <form name="frmSignup" action="Join_Sign_up_action.jsp" method="post">
        <table class="table table-boardered">
            <tr>
                <th>아이디</th>
                <td><input type="text" class="form-control" name="userID" placeholder="영문+숫자를 조합하여 입력해주세요"></td>        
            </tr>
            
                <tr>
                <th>닉네임</th>
                <td><input type="text" class="form-control" name="userNickname" placeholder="별명을 입력해주세요"></td>        
            </tr>
            
            <tr>
                <th>패스워드</th>
                <td><input type="password" class="form-control" name="userPassword" placeholder="영문+숫자를 조합하여 8자리이상 입력해주세요"></td>      
            </tr>
            ...
            <tr>
                <th>이메일</th>
                <td><input type="email" class="form-control" name="userEmail" placeholder="이메일을 입력해주세요"></td>       
            </tr>
             
            <tr>
                <th>전화번호</th>
                <td><input type="tel" class="form-control" name="userPhone" placeholder="전화번호를 입력해주세요"></td>       
            </tr>
             
            <tr>
                <th>주소</th>
                <td><input type="text" class="form-control" name="userAddress" placeholder="주소를 입력해주세요"></td>      
            </tr>

            <br><tr>
                <td colspan="2">
                <input type="submit" class="btn btn-primary" value="회원가입" onclick="check()">
                 <input type="reset" class="btn btn-primary" value="다시입력">
                <a href="Join_Login.jsp"><input type="button" class="btn btn-danger" value="뒤로가기"></a>
                </td>
            </tr>  
        </table>
    </form>
