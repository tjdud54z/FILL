...
function check(){
 ...
 }else if(document.frmSignup.userPassword.value == document.frmSignup.userRePassword.value){
	 alert("비밀번호 확인 성공! 개인정보수정페이지로 넘어갑니다.");
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li class="dropdown">
                        ...
                        <li><a href="Mypage_check.jsp">개인정보수정</a></li>
...
%>	
            ...
            <b style="color: white">환영합니다.</b>&nbsp;&nbsp;&nbsp;&nbsp;<a href="logoutAction.jsp">로그아웃</a>
   ...
   <section style="background-color: #E7E7E7;">
    ...
    <div class="col-sm-6">
    <br><h2>Mypage</h2><br>
    <form name="frmSignup" action="Mypage.jsp" method="post">
    

        <table class="table table-boardered">
        	<tr>
                <th>패스워드</th>
                <td><input type="password" class="form-control" name="userPassword" placeholder="비밀번호를 입력해주세요"></td>      
            </tr>
            ...
            <br><tr>
                <td colspan="2">
                <input type="submit" class="btn btn-primary" value="계속진행" onclick="check()">
                <a href="bbs_exchange.jsp"><input type="button" class="btn btn-danger" value="뒤로가기"></a>
                </td>
            </tr>  
        </table>
    </form>
