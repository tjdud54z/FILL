...
<body id="page-top" class="index">
	...
	<section style="background-color: #E7E7E7;">
		...
		<div class="container">
     <form method="post" action="updateAction.jsp?ex_bbsNo=<%= ex_bbsNo %>">
      <table class="table table-bordered table-hover" style="text-align: center; border: 1px solid #dddddd">
        ...
        <tbody>
         ...
         <tr>
         <td colspan="5" ><form action="uploadAction.jsp" method="post" enctype="multipart/form-data"><input type="file" name="file"></form></td>
         </tr>
        <tr>
