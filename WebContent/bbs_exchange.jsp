							...
							<table class="table table-striped"
								...
								<thead>
									<tr>
										...
										<th style="background-color: dark; text-align: center;">작성자</th>
								...
								<tbody>
									...
									<%
										...
										ArrayList<ExchangeDTO> list = bbsDAO.getList(pageNumber);
									...
									<tr>
										...
										<td><a
											href="view.jsp?ex_bbsNo=<%=list.get(i).getEx_bbsNo()%>"><%=list.get(i).getEx_bbsTitle()%></a></td>
...
<br>
							...
							<a href="bbs_exchange.jsp?pageNumber=<%=pageNumber - 1%>"
