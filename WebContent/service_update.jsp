...
<body id="page-top" class="index">
	...
	<section style="background-color: #E7E7E7;">
		...
		<div class="container">
     <form method="post" action="service_updateAction.jsp?ex_bbsNo=<%= ex_bbsNo %>">
      <table class="table table-bordered table-hover" style="text-align: center; border: 1px solid #dddddd">
      
        <thead>
          <tr>
         <th colspan="3"><h4>글 수정</h4></th> 
          </tr>         
        </thead>
        ...
        <tbody>
         ...
         <td><input class="form-control" type="text" maxlength="50" name="ex_bbsTitle" placeholder="글 제목을 입력하세요" value="<%= bbs.getEx_bbsTitle() %>"></td>
        </tr>
         <tr>         
         <td style="width: 110px;"><h5>글 내용</h5>
         <td><textarea class="form-control" rows="10" name="ex_bbsContent" maxlength="3000" placeholder="글 내용을 입력하세요"><%= bbs.getEx_bbsContent() %></textarea>
        </tr>
         <tr>
         <td colspan="5" ><form action="service_uploadAction.jsp" method="post" enctype="multipart/form-data"><input type="file" name="file"></form></td>
         </tr>
        <tr>
