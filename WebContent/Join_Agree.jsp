...
<div class="topmarginLay_a"></div>
<div class="container sub-layout"></div>
...
function check(){
    var chk1=document.nJoin.join_user_agree.checked;
    var chk2=document.nJoin.join_priv_agree.checked;
...
<div class="jumbotron">
	<h1>필요해u</h1><hr>
	<p>회원가입 약관 및 개인정보 처리방침 안내 동의</p>
</div>
	<div class="row">
		<div class="col-sm-offset-2 col-sm-8">
            <form name='nJoin' role="form" id="joinForm" method="post" action="Join_Sign_up.jsp" autocomplete="off" onSubmit="return check()">
	...
	<input type="hidden" name="nemail" value="">
		<div style="overflow: hidden">
			<div class="col-sm-offset-3 col-sm-6">
				<a href="Join_Sign_up.jsp" style="color: white;"><button class="btn btn-lg btn-primary btn-block" type="submit" >가입 진행</button></a>
			</div>
		</div>
</div>
</div>
